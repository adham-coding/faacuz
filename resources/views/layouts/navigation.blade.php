<nav x-data="{ open: false }" class="fixed top-0 z-50 w-full border-b border-slate-200 bg-slate-100 drop-shadow-md">
    ...
    <div class="flex h-16 justify-between">
      ...
      <div class="hidden sm:ml-6 sm:flex sm:items-center">
        <x-dropdown align="right" width="48">
          <x-slot name="trigger">
            <button
              class="flex items-center text-sm font-medium text-slate-500 transition duration-150 ease-in-out hover:border-slate-300 hover:text-slate-700 focus:border-slate-300 focus:text-slate-700 focus:outline-none">
